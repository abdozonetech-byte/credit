...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'form.age': 'العمر',
    'form.age.placeholder': 'مثال: 32',
    'form.age.error': 'العمر يجب أن يكون بين 18 و65 سنة.',
    'form.city': 'المدينة',
    'form.city.placeholder': 'اختار أو اكتب المدينة',
    'form.institutions': 'مؤسسة أو مؤسسات القرض الحالية',
    'form.institutions.helper': 'يمكنك اختيار مؤسسة واحدة أو أكثر',
    'form.institutions.error': 'اختر مؤسسة قرض واحدة على الأقل.',
    'form.selectAll': 'اختيار الكل',
    'form.financingGroup': 'مؤسسات التمويل',
    'form.banksGroup': 'البنوك',
    'form.other': 'أخرى',
    'form.other.placeholder': 'اكتب اسم المؤسسة',
    'form.public.confirm': 'أؤكد أنني أعمل في القطاع العام أو الوظيفة العمومية.',
    'form.public.required': 'هذه الخدمة مخصصة فقط لموظفي القطاع العام.',
  ...
  fr: {
    ...
    'form.age': 'Âge',
    'form.age.placeholder': 'Exemple : 32',
    'form.age.error': 'L’âge doit être entre 18 et 65 ans.',
    'form.city': 'Ville',
    'form.city.placeholder': 'Sélectionnez ou saisissez la ville',
    'form.institutions': 'Organisme(s) de crédit actuel(s)',
    'form.institutions.helper': 'Vous pouvez sélectionner un ou plusieurs organismes',
    'form.institutions.error': 'Sélectionnez au moins un organisme de crédit.',
    'form.selectAll': 'Tout sélectionner',
    'form.financingGroup': 'Sociétés de financement',
    'form.banksGroup': 'Banques',
    'form.other': 'Autre',
    'form.other.placeholder': "Saisissez le nom de l'organisme",
    'form.public.confirm': 'Je confirme que je travaille dans le secteur public.',
    'form.public.required': 'Ce service est réservé aux employés du secteur public.',
